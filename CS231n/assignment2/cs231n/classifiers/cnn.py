...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        dfc_out, dW3, db3 = affine_backward(dout, fc_cache)
        dhidden_out, dW2, db2 = affine_relu_backward(dfc_out, hidden_cache)
        dconv_out, dW1, db1 = conv_relu_pool_backward(dhidden_out, conv_cache)
